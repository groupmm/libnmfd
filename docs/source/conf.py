...
LIBNMFD_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
assert os.path.exists(os.path.join(LIBNMFD_DIR, 'libnmfd'))
sys.path.insert(0, LIBNMFD_DIR)
#sys.path.insert(0, os.path.join(LIBNMFD_DIR, 'utils'))
...
html_logo = os.path.join(html_static_path[0], 'libnmfd_logo.png')
